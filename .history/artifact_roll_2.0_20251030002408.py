...
ROLE_WEIGHTS_RAW = {
    ...
    "香菱": {"大生命": 0, "大攻击": 75, "大防御": 0, "暴击": 100, "暴伤": 100, "元素精通": 75, "伤害": 100, "物理": 0, "充能效率": 55, "治疗": 0},
...
if __name__ == "__main__":
    ...
    # 常用的说法都能识别, 最简形式: 小攻/生/防, 暴爆充精攻生防
    role = "香菱"
    init =    {"攻":5.8, "暴":3.9, "充":5.8,"爆":5.4}
    current = {"攻":11.1, "暴":3.9, "充":18.8,"爆":19.4}
